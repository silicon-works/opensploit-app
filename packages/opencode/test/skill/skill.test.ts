...
describe("skill", () => {
  it.live("discovers skills from .opensploit/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".opensploit", "skill", "test-skill", "SKILL.md"),
              `---
name: test-skill
      ...
      (dir) =>
        withHome(
          ...
          Effect.gen(function* () {
            yield* Effect.promise(() =>
              Bun.write(
                path.join(dir, ".opensploit", "skill", "dir-skill", "SKILL.md"),
                `---
name: dir-skill
...
`,
            ...
            expect(dirs).toContain(path.join(dir, ".opensploit", "skill", "dir-skill"))
  ...
  it.live("discovers multiple skills from .opensploit/skill/ directory", () =>
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Promise.all([
              Bun.write(
                path.join(dir, ".opensploit", "skill", "skill-one", "SKILL.md"),
                `---
name: skill-one
...
`,
              ...
              Bun.write(
                path.join(dir, ".opensploit", "skill", "skill-two", "SKILL.md"),
                `---
name: skill-two
    ...
    provideTmpdirInstance(
      (dir) =>
        Effect.gen(function* () {
          yield* Effect.promise(() =>
            Bun.write(
              path.join(dir, ".opensploit", "skill", "no-frontmatter", "SKILL.md"),
              `# No Frontmatter
...
`,
              ...
              Bun.write(
                path.join(dir, ".opensploit", "skill", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .opensploit/skill directory.
---
...
`,
              ...
              Bun.write(
                path.join(dir, ".opensploit", "skills", "agent-skill", "SKILL.md"),
                `---
name: opencode-skill
description: A skill in the .opensploit/skills directory.
---
