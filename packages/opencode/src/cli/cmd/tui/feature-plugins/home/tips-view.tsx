...
const TIPS = [
  ...
  "Add {highlight}.md{/highlight} files to {highlight}.opensploit/command/{/highlight} to define reusable custom prompts",
  "Use {highlight}$ARGUMENTS{/highlight}, {highlight}$1{/highlight}, {highlight}$2{/highlight} in custom commands for dynamic input",
  "Use backticks in commands to inject shell output (e.g., {highlight}`git status`{/highlight})",
  "Add {highlight}.md{/highlight} files to {highlight}.opensploit/agent/{/highlight} for specialized AI personas",
  ...
  "Add {highlight}.ts{/highlight} files to {highlight}.opensploit/plugin/{/highlight} for event hooks",
