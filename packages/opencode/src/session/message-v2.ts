 ...
 */
export const TVARPart = Schema.Struct({
  ...partBase,
  type: Schema.Literal("tvar"),
  ...
  phase: Schema.optional(
    Schema.Literals(["reconnaissance", "enumeration", "exploitation", "post_exploitation", "reporting"]),
  ),
  time: Schema.Struct({
    start: NonNegativeInt,
    end: Schema.optional(NonNegativeInt),
  }),
}).annotate({ identifier: "TVARPart" })
export type TVARPart = Types.DeepMutable<Schema.Schema.Type<typeof TVARPart>>
