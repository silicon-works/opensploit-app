      ...
      const handleEvent = Effect.fnUntraced(function* (value: StreamEvent) {
        switch (value.type) {
          ...
          case "text-end":
            ...
            if (value.providerMetadata) ctx.currentText.metadata = value.providerMetadata
            // Parse <thought>/<verify>/<action>/<result> blocks out of the finalized
            // text into structured TVARParts and strip them from the visible text.
            // The structured parts are consumed by the trajectory recorder downstream.
            {
