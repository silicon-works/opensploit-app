...
description: How OpenSploit orchestrates 25+ security tools via MCP Docker containers, organized by pentest phase.
---
...
:::note
This page covers the security-specific MCP tools. For configuring built-in LLM tools (bash, edit, read, etc.), see [Tools](/docs/tools).
:::
