...
description: OpenSploit's five-phase penetration testing methodology with automated phase transitions and tool recommendations.
---
...
:::tip
You can manually override the current phase with `/phase exploitation` or any other phase name.
:::
...
|-------|-------------|-------------|
| Reconnaissance | nmap | sqlmap, metasploit |
